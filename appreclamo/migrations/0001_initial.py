# Generated by Django 3.0.5 on 2022-02-11 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Otros_agentes', models.CharField(blank=True, max_length=150)),
                ...
                ('cod_agente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appreclamo.Agentes')),
                ('cod_repart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appreclamo.Reparticion')),
            ],
        ),
        migrations.CreateModel(
            name='Pagos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telef_contacto', models.CharField(blank=True, max_length=12)),
                ('turno', models.CharField(blank=True, max_length=30)),
                ('cuil', models.CharField(blank=True, max_length=12)),
                ('Fecha_nac', models.DateField(null=True)),
                ('observacion', models.CharField(blank=True, max_length=150)),
                ('cod_func', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appreclamo.Funcion')),
                ('cod_sitlab', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appreclamo.Sitlab')),
            ],
        ),
    ]
